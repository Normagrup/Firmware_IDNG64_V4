...
// >> FUNCIONES.
    ...
    void sensoresNotificar (sensoresOrigenNotificacion origenNotificacion, interfacesEventos eventoInterfaz)
    {
        ...
        unsigned char sensorAddress;
				...
				#ifdef DEBUG_SENSORS_INTERFACE_RECEIVED
					unsigned char debugFrame[DEBUG_SENSORS_INTERFACE_RECEIVED_FRAME_LENGHT];
				#endif
            ...
            if (configuracion.instalado==TRUE)
            {
                if (configuracion.desactivado==FALSE)
                {
                    ...
                    eventoSensor.lectura=eventoInterfaz.lectura;									
											...
											debugFrame[1]=0xFF;	
											debugFrame[2]=0xFF;						
											debugFrame[3]=DEBUG_SENSORS_INTERFACE_RECEIVED_OP;
											...
											ethSendFrame(0,&debugFrame[0],DEBUG_SENSORS_INTERFACE_RECEIVED_FRAME_LENGHT,&_broadcastAddress[0], DEBUG_SENSORS_INTERFACE_RECEIVED_PORT);	
										#endif																				
